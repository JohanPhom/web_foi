<?php
/* Smarty version 3.1.34-dev-7, created on 2020-06-14 15:52:57
  from 'D:\Wamp64\www\PROJET\other\documentation.php' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5ee62bb9de9095_83257989',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e5d2a405aab31adc5e150db09d2ff3496155bb7a' => 
    array (
      0 => 'D:\\Wamp64\\www\\PROJET\\other\\documentation.php',
      1 => 1592142774,
      2 => 'file',
    ),
  ),
...
function content_5ee62bb9de9095_83257989 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<!--
...
>
    ...
    <meta name="description" content="Documentation era model">
</head>
    ...
    <section id="mainContent">
        <div class="background">
            <div id="author_box">
                ...
                <h1 style="text-align:center;">Documentation</h1><br>

                <div >
                    <h2>Project assignment</h2>
                    During this project I had to create a web site about fan clubs. Here you can join any club you want to, by passing a test 
                    prepared by any administrator or the creator of the fan club. If you get 50% of total points from the test you are accepted in the club.
                    <br>Once you are in the club, you will be able to participate to discussion through a forum system. You can create a topic by asking a 
                    question and you can answer to other's question. If your answer is good, any administrator or moderator of the club will be able
                    to choose your answer as "best answer" and the topic is no longer available. You can also buy items from the club you belong.
                    But you need to get some points by participating to discussions.<br>You have a profil page that can be accessed by clicking on your
                    username a the top of the page so you can check your statistics.<br>Everything is recorded in a log page that can be visited only by
                    the administrator.<br>You can choose your theme (dark or soft).<br>Every moderator and administrator are able to view their club's
                    stats : Who passed the test, fail or success, when etc... and also forums stats (how many answers/questions).<br>The administrator
                    is able to set the parameters like duration of email validation code, duration of the session, pagination etc...<br>
                    Everything can be deleted : users, item, club, test etc...<br><br>Self evaluation - completion of the project : 70%
                </div>
            </div>
            <img src="source_files/era.png" alt="era model" width="80%;" style="margin: 20px auto;">
