<?php
/* Smarty version 3.1.34-dev-7, created on 2020-06-12 17:59:14
  from 'D:\Wamp64\www\PROJET\fanPage.php' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5ee3a652b54212_30741780',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '673034803a73213303e21bda25d40499e86d65d5' => 
    array (
      0 => 'D:\\Wamp64\\www\\PROJET\\fanPage.php',
      1 => 1591977552,
      2 => 'file',
    ),
  ),
...
function content_5ee3a652b54212_30741780 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<!--
...
"><button class="button">Stat forum</button></a>
                        ...
                        <div>
                            <p><img src="multimedia/writer.png" alt="icone" height="25px"> Author : <b><?php echo $_smarty_tpl->tpl_vars['club']->value->author;?>
</b></p>
                            <p><img src="multimedia/item.png" alt="icone" height="25px"> Number of different item : <b><?php echo $_smarty_tpl->tpl_vars['club']->value->nb_item;?>
</b></p>
                            <p><img src="multimedia/suscribers.png" alt="icone" height="25px"> Suscribers : <b><?php echo $_smarty_tpl->tpl_vars['club']->value->nb_member;?>
</b></p>
                            <p><img src="multimedia/date.png" alt="icone" height="25px"> Creation date : <b><?php echo $_smarty_tpl->tpl_vars['club']->value->date_creation;?>
</b></p>
                            <p><img src="multimedia/login_icon.png" alt="icone" height="25px"> Creator user : <b><?php echo $_smarty_tpl->tpl_vars['club']->value->creator_user;?>
</b></p>
                        </div>
...
#list_item"><img class="arrow" src="multimedia/left_arrow.png" alt="left arrow" height="40px"></a>
                            <?php }?>
                                Items
                            <?php if (isset($_smarty_tpl->tpl_vars['list_item']->value)) {?>
                                <?php if (count($_smarty_tpl->tpl_vars['list_item']->value) == $_smarty_tpl->tpl_vars['pagination']->value) {?>
                                    <a href="index.php?page=fanPage&ID=<?php echo $_smarty_tpl->tpl_vars['club']->value->ID;?>
&offset=<?php echo $_smarty_tpl->tpl_vars['offset']->value+1;?>
#list_item"><img class="arrow" src="multimedia/right_arrow.png" alt="right arrow" height="40px"></a>
                                <?php }?>
                            <?php }?>
                        </h1>
...
"><img class="cross_item" src="multimedia/croix.png" alt="cross" height="30px"></a>
                            <?php }?>
...
" class="button_add_item"><button class="button">Add new item</button></a>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['user']->value->role < 4) {?> <div id="new_question_forum">
...
">
                                        <img src="multimedia/croix.png" alt="cross" height="20px">
                                    </a>
                                <?php }?>
                            </li>
                            <br>
